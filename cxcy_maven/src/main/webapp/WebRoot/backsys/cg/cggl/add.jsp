...
<link href="/cxcy/backsys/res/css/admin.css" rel="stylesheet" type="text/css"/>
<link href="/cxcy/backsys/res/css/theme.css" rel="stylesheet" type="text/css"/>
<script src="/cxcy/thirdparty/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
<script src="/cxcy/backsys/res/js/regcheckdata.js" type="text/javascript"></script>
...
<div class="box-positon">
	<div class="rpos">当前位置: 成果 - 成果添加</div>
	<form class="ropt" method="post">
		<input type="submit" value="返回列表" onclick="this.form.action='/cxcy/backsys/cg/cggl/admin.jsp<%=resp %>';" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
