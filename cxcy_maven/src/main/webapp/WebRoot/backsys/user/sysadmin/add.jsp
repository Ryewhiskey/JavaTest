...
<%
	...
	String flag="";
	String yhbh=UId,yhm="",realname="",phone="",xb="男",mm="",bmbh="",glyz="2",islock="1";//1-否   2-禁用	
	int count = 0; 	
	...
	{		
		...
		String prepsql="insert into admin(yhbh,yhm,realname,phone,xb,mm,bmbh,glyz,islock) values(?,?,?,?,?,?,?,?,?)";		
		boolean result = DataBase.prepare(datasource,prepsql,yhbh,yhm,realname,phone,xb,mm,bmbh,Integer.parseInt(glyz),Integer.parseInt(islock));					
...
<div class="box-positon">
	<div class="rpos">当前位置: 管理员 - 管理员添加</div>
	...
	<form method="post" action="add.jsp" id="jvForm" name="form1" onSubmit="return datacheck();">
		...
		<tr>
			...
			<td colspan="1" width="38%" class="pn-fcontent">
				<input type="text" maxlength="100" name="yhm" value="<%=yhm %>" onchange="uni_yhm('uni_yhm.jsp?yhm='+this.value)"/>
