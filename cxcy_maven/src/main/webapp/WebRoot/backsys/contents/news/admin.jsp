...
<%
	...
	if(flag == null || flag.equals("form1") ){	
		...
		sql = "select id,title,fbr,fbrq,content,issuccess from news where id!='1' and id!='2' ";						
	...
	{	String id="";	
		...
		delcount=DataBase.executeUpdate(datasource,"delete from news where id = '" + id + "'");
		if(delcount==0){
%>
...
<div class="box-positon">
	<div class="rpos">当前位置: 新闻 - 新闻管理</div>
	<form class="ropt">
...
<form name="form1" action="admin.jsp" method="post" style="padding-top:5px;padding-bottom:5px;">
	...
	新闻标题: <input type="text" name="query1" value="<%=query1 %>" style="width:100px"/>
	...
	新闻内容: <input type="text" name="query4" value="<%=query4 %>" style="width:150px"/>
...
<%
	if(sql!=null && !"".equals(sql) ){	
		...
		for (Iterator<Object[]> it=notes.iterator();it.hasNext();i++) {	
			Object[] note = it.next();	
			if("0".equals(note[5].toString()))	note[5]="0-未审核";
			if("1".equals(note[5].toString()))	note[5]="1-审核";											
%>
