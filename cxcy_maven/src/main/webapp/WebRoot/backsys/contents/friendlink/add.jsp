...
<%
	...
	{		
		...
		String prepsql="insert into friendlink(id,name,addr) values(?,?,?)";		
		boolean result = DataBase.prepare(datasource,prepsql,UId,name,addr);					
...
<div class="box-positon">
	<div class="rpos">当前位置: 内容 - 友情链接添加</div>
