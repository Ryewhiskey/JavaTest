...
<%
	...
	if(flag == null || flag.equals("form1") ){	
		...
		sql = "select id,name from xkdmb where 1=1 ";						
		if( query1 !=null && !"".equals(query1) ){
			sql += " and " + "id like '%"+query1+"%' ";
		}
	...
	{	String id="";	
		...
		delcount=DataBase.executeUpdate(datasource,"delete from xkdmb where id = '" + id + "'");
		if(delcount==0){
%>
...
<div class="box-positon">
	<div class="rpos">当前位置: 辅助 - 一级学科</div>
	<form class="ropt">
...
<form name="form1" action="admin.jsp" method="post" style="padding-top:5px;padding-bottom:5px;">
	...
	学科代码: <input type="text" name="query1" value="<%=query1 %>" style="width:100px"/>
	学科名称: <input type="text" name="query2" value="<%=query2 %>" style="width:150px"/>
  ...
  <tr onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">   	  	  
    ...
    <td class="style3" ><div align="center"><% if(note[1]!=null) out.print(note[1].toString());else out.print("&nbsp;"); %></div></td>
   	<td class="style3" ><div align="center">
    	...
    	<a href="updt.jsp?old_id=<%=note[0].toString() %> ">修改</a>
