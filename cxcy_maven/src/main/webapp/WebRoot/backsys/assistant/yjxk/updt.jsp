...
<%
	...
	String flag="";
	String id="",name="",old_id="";	
		
	flag = request.getParameter("flag");
	old_id = request.getParameter("old_id");
	if( old_id!=null && !"".equals(old_id.trim()) ){
		String sql = "select id,name from xkdmb where id = '" + old_id + "'";
	...
	{		
		...
		String prepsql="update xkdmb set id=?,name=? where id='"+old_id+"'";
...
<div class="box-positon">
	<div class="rpos">当前位置: 辅助 - 学科代码修改</div>
...
<div class="body-box">
	<form method="post" action="updt.jsp" id="jvForm" name="form1" onSubmit="return datacheck();">
		...
		<tr>
			...
			<td width="12%" class="pn-flabel pn-flabel-h"><span class="pn-frequired">*</span>学科名称:</td>
			<td colspan="1" width="38%" class="pn-fcontent">
