...
<%
	...
	if(flag == null || flag.equals("form1") ){	
		...
		sql = "select id,zxr,zxrname,zxrq,zxcnt,hfr,hfrname,hfrq,hfcnt from v_zx where 1=1 ";						
...
<form name="form1" action="admin.jsp" method="post" style="padding-top:5px;padding-bottom:5px;">
	...
	咨询人: <input type="text" name="query1" value="<%=query1 %>" style="width:70px"/>&nbsp;&nbsp;
	咨询日期: <input type="text" name="query2" value="<%=query2 %>"  style="width:80px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/> - 
			<input type="text" name="query3" value="<%=query3 %>" style="width:80px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/>&nbsp;&nbsp;
	回复人: <input type="text" name="query4" value="<%=query4 %>" style="width:70px"/>&nbsp;&nbsp;
	回复日期: <input type="text" name="query5" value="<%=query5 %>"  style="width:80px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/> - 
			<input type="text" name="query6" value="<%=query6 %>" style="width:80px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/>&nbsp;&nbsp;
...
%>
  <tr onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'"> 
    ...
    <td class="style3" ><div align="center"><% if(note[4]!=null) if(note[4].toString().length()>21) out.print(note[4].toString().substring(0, 20)+"..."); else out.print(note[4].toString()); else out.print("&nbsp;"); %></div></td>
    ...
    <td class="style3" ><div align="center"><% if(note[8]!=null) if(note[8].toString().length()>21) out.print(note[8].toString().substring(0, 20)+"..."); else out.print(note[8].toString()); else out.print("&nbsp;"); %></div></td>
	</a>   
