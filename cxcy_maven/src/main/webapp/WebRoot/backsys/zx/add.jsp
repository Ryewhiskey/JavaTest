...
<%
	...
	String flag="";	
	String id=UId,zxr=((Map<String,String>)session.getAttribute("userinfo")).get("yhbh");
	String zxrname = ((Map<String,String>)session.getAttribute("userinfo")).get("realname");
	...
	{		
		...
		String prepsql="insert into zxb(id,zxr,zxrq,zxcnt,hfrq,hfr,hfcnt) values(?,?,?,?,?,?,?)";		
		boolean result = DataBase.prepare(datasource,prepsql,UId,zxr,zxrq,zxcnt,hfrq,hfr,hfcnt);					
