...
<div class="box-positon">
	<div class="rpos">当前位置: 项目 - 项目添加</div>
	...
	<form method="post" action="add.jsp" id="jvForm" name="form1" onSubmit="return datacheck();">
		...
		<tr>
			...
			<td colspan="1" width="38%" class="pn-fcontent">
				<input type="text" name="xmbh" value="<%=xmbh %>" <%if( !"1".equals(((Map<String,String>)session.getAttribute("userinfo")).get("glyz")) ) out.print("readonly"); %>/>				
			</td>
